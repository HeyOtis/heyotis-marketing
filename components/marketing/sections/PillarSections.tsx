...
const PILLARS = [
  {
    ...
    chipDot: "bg-salmon",
    name: "AEO Insights",
    heading: "AEO Insights",
    body: "See how every assistant answers about you — visibility, sentiment, citations and share of voice, tracked across the queries that decide purchases.",
