...
export const metadata = buildMetadata({
  title: "Pricing",
  description:
    "HeyOtis pricing is contact-sales across four tiers — Basic, Plus, Premium and Enterprise. Plans scale with your tracked brands, prompt volume, AI responses and competitor sets across ChatGPT, Gemini and Perplexity. Talk to us for a tailored quote.",
  path: "/pricing",
});
...
const FAQS: FaqItem[] = [
  {
    ...
    a: "HeyOtis is contact-sales across four tiers — Basic, Plus, Premium and Enterprise. Each plan is scoped to your number of tracked brands, active prompts, monthly AI responses and competitor set size, all monitored across ChatGPT, Gemini and Perplexity. Book a chat and we'll size a plan to your category and goals.",
  },
  {
    q: "Is there a free trial or self-serve sign-up?",
    a: "No. HeyOtis is demo-led rather than self-serve. We book a short call, run your brand against ChatGPT, Gemini and Perplexity, walk you through a sample report, and then tailor a plan — so campaigns reflect your real competitors and category from day one.",
  },
  {
    q: "What counts as an AI response?",
    a: "An AI response is a single prompt sent to one AI engine with its answer captured and analysed. So one prompt run across ChatGPT, Gemini and Perplexity counts as three AI responses. Your monthly volume is driven by the number of active prompts, the engines you track, and how often campaigns run.",
  },
  {
    ...
    <>
        ...
        <Container className="pt-28 pb-12 sm:pt-32 md:pb-16 lg:pt-36">
          <div className="max-w-3xl">
            ...
            >
              ...
              Gemini and Perplexity. Pick the tier that fits and we&apos;ll size
              the rest with you.
            </p>
      ...
      <Section surface="cream" className="pt-4 md:pt-6">
        <SectionHeading
          ...
          sub="Every tier monitors ChatGPT, Gemini and Perplexity. The difference is scale — how many brands, prompts, AI responses and competitors you track, plus the depth of strategy and support."
          className="max-w-2xl"
        />
      ...
      <CtaBand
        ...
        sub="Book a 20-minute walkthrough. We'll run your brand against ChatGPT, Gemini and Perplexity, show you the gaps, and recommend the tier that fits."
      />
    </>
  );
}
